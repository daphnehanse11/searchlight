        ...
        <div className="mt-6 code-block max-w-3xl w-full">
          ...
          <div className="code-block-content">
            <p className="text-green-400">
              &gt; What would doubling the EITC and raising the top two marginal tax rates by 2 percentage points do to federal revenue, and how would it affect incomes across the distribution?
            </p>
          </div>
        </div>
